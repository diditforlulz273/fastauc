...
if __name__ == '__main__':
    ...
    print(f'C++ fast AUC = {cpp_auc.roc_auc_score(y_true, y_prob, sample_weight=weights)}')
    ...
    print(f"C++ fast AUC 10000 calls time = {timeit.timeit('cpp_auc.roc_auc_score(y_true, y_prob, sample_weight=weights)', number=10000, globals=globals())}")